...
import kotlinproject.composeapp.generated.resources.ic_bars_tab_bar_x_cart
...
object BasketTab : Tab {
    ...
    override val options: TabOptions
        @Composable
        get() {
            val title = "корзина".uppercase()
            val icon = rememberVectorPainter(vectorResource(Res.drawable.ic_bars_tab_bar_x_cart))
